            ...
            ? (
              <>
                <div className="sidebarItem">
                  <a href="/dashboard" className="sidebarTitle">Dashboard</a>
                </div>
                <div className="sidebarItem">
                  <a href='/employees' className="sidebarTitle">Employees</a>
                </div>
                <div className="sidebarItem">
                  <a href='/reports' className="sidebarTitle">Reports</a>
                </div>
                <div className="sidebarItem">
                  <a href='/settings' className="sidebarTitle">Settings</a>
                </div>
              </>
              )
            : (
              <>
                <div className="sidebarItemHidden">
                  <a href='/dashboard'>
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 512 512"><path d="M0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm320 96c0-26.9-16.5-49.9-40-59.3V88c0-13.3-10.7-24-24-24s-24 10.7-24 24V292.7c-23.5 9.5-40 32.5-40 59.3c0 35.3 28.7 64 64 64s64-28.7 64-64zM144 176a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm-16 80a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm288 32a32 32 0 1 0 0-64 32 32 0 1 0 0 64zM400 144a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z"/></svg>
                  </a>
                </div>
                <div className="sidebarItemHidden">
                  <a href='/employees'>
                ...
                <div className="sidebarItemHidden">
                  <a href='/reports'>
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 384 512"><path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z"/></svg>
                  </a>
                </div>
                <div className="sidebarItemHidden">
                  <a href='/settings'>
